...
//     $('#sidebar ul#navbar li.nav-item').hover(function(){
//         // $('#sidebar ul#navbar li.nav-item ul.sub-menu').slideToggle();
//         // alert('ok')
//     })
...
$(document).ready(function () {
    ...
    $('.custom .custom-item span').click(function () {
        $('.custom .custom-item .custom-detail').slideUp('100');
        $(this).parent('.custom .custom-item').children('.custom .custom-item .custom-detail').stop().slideToggle('100');
    });

    ...
    <div id="business" class="row">
        <div id="day-business" class="col-md-9 row">
            ...
            <div id="top-conversion-rate" class="col-md-4 popular">
                ...
                <div class="pp-data">
                    <img src="{{ asset('img/tải xuống (2).png') }}" alt="">
                </div>
            </div>
        </div>
        <div class="col-md-3" id="diary-activity">
            ...
            <div class="diary-item">
                ...
                <div class="diary-detail">
                    <span class="name">Đoàn Đức Toàn</span>
                    <span class="diary-content">Đã nhận 500.000đ tiền thanh toán cho sản phẩm với mã
                        #10472</span>
                    <span class="time-send">4/13/2023</span>
                </div>
            </div>

            <div class="diary-item see-more"><a href="#">Xem thêm</a></div>
        </div>
    </div>

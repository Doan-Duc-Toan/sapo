        ...
        <div class="main-content row col-md-12">
            ...
            <ul class="status col-md-12 d-flex">
                <li class="status-item all"><a href="{{ request()->fullurlWithQuery(['status' => 'active']) }}"
                        class="text-secondary">Tất cả người dùng</a></li>
                <li class="status-item all"><a href="{{ request()->fullurlWithQuery(['status' => 'trash']) }}"
                        class="text-secondary">Người dùng đã xóa</a></li>
            </ul>

    ...
    <div class="slide center">
        <div class="slide-img-cover">
            <div class="owl-carousel owl-theme">
                <div class="slide-item"> <a href="#"><img src="{{asset('client/img/slide-img1.webp')}}" alt=""></a> </div>
                <div class="slide-item"> <a href="#"><img src="{{asset('client/img/slide-img2.webp')}}" alt=""></a></div>
                <div class="slide-item"> <a href="#"><img src="{{asset('client/img/slide-img1.webp')}}" alt=""></a> </div>
                <div class="slide-item"> <a href="#"><img src="{{asset('client/img/slide-img2.webp')}}" alt=""></a> </div>
            </div>
        </div>
...
<div id="content">
    <div class="row" id="strong-point">
        <div class="col-md-3">
            <div>
                <span class="sp-icon"><img src="img/icon2-01-600x577.png" alt=""></span>
                <span class="sp-title center">Sản phẩm an toàn</span>
            </div>
        </div>
        <div class="col-md-3">
            <div>
                <span class="sp-icon"><img src="img/icon-chat-luong.png" alt=""></span>
                <span class="sp-title center">Chất lượng cam kết</span>
            </div>
        </div>
        <div class="col-md-3">
            <div>
                <span class="sp-icon"><img src="img/icon3-5fc5a756a1348.png" alt=""></span>
                <span class="sp-title center">Dịch vụ vượt trội</span>
            </div>
        </div>
        <div class="col-md-3">
            <div>
                <span class="sp-icon"><img src="img/icon-giao-hang-2b770097b24073e6975d78c45719c53c.png"
                        alt=""></span>
    ...
    <div id="cat-ost">
        ...
        <ul class="list-cat">
            <li class="cat-item">
                <a href="">
                    <img src="img/iphone-x-64gb-1.png" alt="">
                    <span>Điện thoại</span>
                </a>
            </li>
            <li class="cat-item">
                <a href=""><img src="img/th (2).jpg" alt="">
                    <span>Smart watch</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (3).jpg" alt="">
                    <span>Laptop</span>
                </a>
            </li>
            <li class="cat-item">
                <a href=""><img src="img/th (4).jpg" alt="">
                    <span>Máy tính bảng</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (5).jpg" alt="">
                    <span>Thiết bị mạng</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (6).jpg" alt="">
                    <span>Ti vi</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (7).jpg" alt="">
                    <span>Tai nghe</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (8).jpg" alt="">
                    <span>Ốp lưng, bao da</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (9).jpg" alt="">
                    <span>Loa</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (10).jpg" alt="">
                    <span>Pin dự phòng</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (11).jpg" alt="">
                    <span>Cáp, củ sạc</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (12).png" alt="">
                    <span>màn hình</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (13).png" alt="">
                    <span>Chuột</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (14).png" alt="">
                    <span>Bàn phím</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (15).webp" alt="">
                    <span>Phụ kiện gaming</span></a>
            </li>
            <li class="cat-item">
                <a href=""> <img src="img/th (16).webp" alt="">
